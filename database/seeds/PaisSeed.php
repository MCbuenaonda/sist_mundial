...
class PaisSeed extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('pais')->insert(['nombre' => 'Islas Vírgenes Estadounidenses', 'siglas' => 'VIR', 'iso' => 'VI', 'confederacion_id' => 3, 'puntos' => 0, 'user_id' => 1,'lat' => 18.34,'lng' => -64.93 ,'federacion' => 'FEDERACIÓN DE FÚTBOL DE LAS ISLAS VÍRGENES AMERICANAS']);
        ...
        DB::table('pais')->insert(['nombre' => 'Países Bajos', 'siglas' => 'NED', 'iso' => 'NL', 'confederacion_id' => 1, 'puntos' => 0, 'user_id' => 1,'lat' => 52.5,'lng' => 5.75 ,'federacion' => 'FEDERACIÓN NEERLANDESA DE FÚTBOL']);
        ...
        DB::table('pais')->insert(['nombre' => 'Samoa Estadounidense', 'siglas' => 'ASA', 'iso' => 'AS', 'confederacion_id' => 5, 'puntos' => 0, 'user_id' => 1,'lat' => -14.33333333,'lng' => -170 ,'federacion' => 'FEDERACIÓN DE FÚTBOL DE LA SAMOA ESTADOUNIDENSE']);
